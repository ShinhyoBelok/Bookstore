...
**Book Store** is a website that allows you to create a list of books that you want to save online.
...
Feel free to check the [issues page](https://github.com/ShinhyoBelok/BookStore/issues).
